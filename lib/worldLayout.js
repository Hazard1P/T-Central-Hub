export const WORLD_LAYOUT = [
  ...
  { key: 'deep_blackhole', label: 'Deep Standalone Blackhole', address: 'Standalone system anchor', description: 'Independent standalone blackhole system.', position: [-17.2, -3.6, -5.8], color: '#c4d4ff', kind: 'blackhole', priority: 6 },
