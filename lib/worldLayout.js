export const WORLD_LAYOUT = [
  ...
  { key: 'ss', label: 'Synaptic Systems', address: 'synaptics.systems/ndsp', description: 'Synaptic Systems Dyson sphere anchored to NDSP.', position: [13.8, -1.4, 6.0], color: '#ffd67d', route: 'https://synaptics.systems/ndsp', external: true, kind: 'dyson', priority: 6 },
...
export const ROUTE_CHIPS = ['Arma3 CTH', 'MatrixCoinExchange', 'Rust', 'CSIS', 'Synaptic Systems', 'Affiliates'];
