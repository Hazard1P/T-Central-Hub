export const WORLD_LAYOUT = [
  ...
  { key: 'deep_blackhole', label: 'Deep Space Blackhole', address: 'Primary deep-space anchor', description: 'Deep-space blackhole reusing the existing cosmic map and anchor assets already present in the project, so the map and its anchorage stay aligned with the rest of the world.', position: [-17.2, -3.6, -5.8], color: '#c4d4ff', kind: 'blackhole', priority: 6, mapAsset: '/cosmic-map.jpg', seedAsset: '/blackhole-anchor.jpg', tags: ['deep space', 'map anchor', 'existing anchorage'] },
